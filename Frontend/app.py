...
st.markdown(
    ...
    <div class="hero-box">
        ...
        <div class="hero-subtitle">
            ...
            This demo uses the best-performing model: <b>{BEST_MODEL_NAME}</b>.
        </div>
    </div>
    ''',
    unsafe_allow_html=True,
...
st.markdown(
    f'''
    <div class="info-box">
        <b>Best Overall Model:</b> {best_row["Model"]}<br>
        <b>Accuracy:</b> {best_row["Accuracy"]:.4f}<br>
        <b>Macro F1:</b> {best_row["Macro F1"]:.4f}
    </div>
    ''',
    unsafe_allow_html=True,
)
...
with f3:
    ...
    st.markdown("**Email:** akshitrohilla.in@gmail.com")

st.markdown("---")
st.markdown(
    '''
    <div style="display:flex; justify-content:space-between; color:#475569; font-size:0.95rem;">
        <div>© 2026 Road Issues Detection. All rights reserved.</div>
        <div>Student project · Smart City Infrastructure Monitoring</div>
    </div>
    ''',
    unsafe_allow_html=True,
)
